 ...
 * @Version: 0.1.0
 * @Author: AiDongYang
 * @Date: 2021-07-20 13:07:26
 * @LastEditors: AiDongYang
 * @LastEditTime: 2021-07-20 13:15:12
-->
<template>
	<div class="scrollbar">
...
<script lang="ts">
	import { addResizeListener, removeResizeListener } from 'src/utils/event'
	import { scrollbar } from 'src/settings'
